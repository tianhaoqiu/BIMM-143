...
![](class_15_files/figure-markdown_github/unnamed-chunk-7-1.png)
...
```
    ...
    ## ENSG00000279457    0.686554781181763          NA          NA          NA
    ## ENSG00000187634  0.00515718187738401      SAMD11      148398   Hs.335293
    ## ENSG00000188976 1.76549251753639e-35       NOC2L       26155   Hs.405987
    ## ENSG00000187961  1.1341301979147e-07      KLHL17      339451   Hs.109212
    ## ENSG00000187583    0.919030615798602     PLEKHN1       84069   Hs.528691
    ## ENSG00000187642    0.403379315307624       PERM1       84808   Hs.271462
    ## ENSG00000188290 1.30538272876052e-24        HES4       57801   Hs.154029
    ## ENSG00000187608   0.0237452302085195       ISG15        9636   Hs.458485
    ## ENSG00000188157 4.21963223349393e-16        AGRN      375790   Hs.273330
...
```
    ...
    ##  /var/folders/kq/jbv4n7x11m336r9lx0nh0rdr0000gn/T//RtmpQCxXYG/downloaded_packages

    ## installing the source package 'gageData'

    ## Update old packages: 'BiocInstaller', 'boot', 'cluster', 'dendextend',
    ##   'DESeq2', 'digest', 'dplyr', 'ggrepel', 'igraph', 'knitr', 'nlme',
    ##   'org.Hs.eg.db', 'pillar', 'processx', 'progress', 'sys', 'testthat',
    ##   'tinytex', 'xfun', 'zip'

Section Two - Pathway Analysis
------------------------------
...
```
    ...
    ## Info: Working in directory /Users/qiutianhao/Desktop/BIMM 143 - Bioinformatics Laboratory/R project/bimm143_github/class 15/class 15
